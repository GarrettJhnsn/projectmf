...
func getRoutes() http.Handler {
	...
	mux.Get("/", Repo.Home)
	mux.Get("/favicon", Repo.DoNothing)
	mux.Get("/success", Repo.Success)
	mux.Get("/login", Repo.Login)
	mux.Get("/packages", Repo.Packages)

	mux.Get("/consultation", Repo.Consultation)
	mux.Post("/consultation", Repo.PostConsultation)

	mux.Get("/confirmation", Repo.Confirmation)

	mux.Get("/tos", Repo.TermsOfService)
